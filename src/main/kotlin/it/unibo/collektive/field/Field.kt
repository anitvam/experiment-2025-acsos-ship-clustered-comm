...
// */
//sealed interface Field2<ID : Any, out T> {
//    /**
...
//    override val neighbors: List<ID> by lazy { others.map { it.first } }
//
...
//
//    override val neighbors: Set<ID> by lazy { others.map { it.first }.toSet() }
//
